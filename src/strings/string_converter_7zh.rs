const START: u16 = 0xE800;
const END: u16 = 0xEE26;

#[rustfmt::skip]
const TABLE: [char; 1575] = [
...
fn is_private_char(glyph: u16) -> bool {
    glyph >= START && glyph <= END
}

pub fn get_unicode_char(glyph: u16) -> u16 {
    if !is_private_char(glyph) {
        return glyph;
    }
    TABLE[(glyph - START) as usize] as u16
}
